      ...
      {selectedItem && (
        ...
        >
          ...
          >
            ...
            {/* Info Section */}
            <div className="flex flex-col md:flex-row justify-between items-start bg-white">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-sm text-neutral-600 mb-4">
                  ...
                  {selectedItem.type === "video" ? (
                    ...
                    <span className="flex items-center">
                      <Camera className="h-10 w-10 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
              ...
              {/* Navigation Info */}
              <div className="p-4 bg-white border-t text-right text-sm text-neutral-800">
