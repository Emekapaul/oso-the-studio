...
export default function VideoPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-64 sm:h-80 lg:h-96 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
            Video <span className="text-amber-400">Portfolio</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-neutral-900 mb-4 sm:mb-6">
              Video <span className="text-amber-600">Gallery</span>
            </h2>
            ...
            {filteredVideos.map((video) => (
              ...
              >
                ...
                <div className="relative aspect-video overflow-hidden rounded-t-xl sm:rounded-t-2xl">
                 ...
                 33vw"
                  ...
                  <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="bg-amber-600 rounded-full p-3 sm:p-4 transform scale-75 group-hover:scale-100 transition-transform duration-300">
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-bold text-neutral-900 mb-2 group-hover:text-amber-600 transition-colors duration-200 line-clamp-2">
                    {video.title}
                  </h3>
      ...
      {selectedVideo && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-gradient-to-br from-neutral-900/95 via-neutral-800/95 to-warm-brown/95 backdrop-blur-sm"
          onClick={closeModal}
        >
          <div
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-neutral-900 via-neutral-800 to-warm-brown relative">
        {/* Background Pattern */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6">
              Video <span className="text-warm-brown-300">Services</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-6 sm:p-8 bg-neutral-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl hover:shadow-lg transition-shadow duration-300 border border-neutral-700/50">
              <Award className="h-10 w-10 sm:h-12 sm:w-12 text-warm-brown-300 mx-auto mb-4" />
            ...
            <div className="text-center p-6 sm:p-8 bg-neutral-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl hover:shadow-lg transition-shadow duration-300 border border-neutral-700/50">
              <Camera className="h-10 w-10 sm:h-12 sm:w-12 text-warm-brown-300 mx-auto mb-4" />
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                Corporate Videos
              </h3>
              <p className="text-neutral-300 text-sm sm:text-base">
            ...
            <div className="text-center p-6 sm:p-8 bg-neutral-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl hover:shadow-lg transition-shadow duration-300 border border-neutral-700/50 sm:col-span-2 lg:col-span-1">
              <Play className="h-10 w-10 sm:h-12 sm:w-12 text-warm-brown-300 mx-auto mb-4" />
              <h3 className="text-lg sm:text-xl font-bold text-white mb-3">
                Event Coverage
              </h3>
              <p className="text-neutral-300 text-sm sm:text-base">
