...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay - Optimized for all screen sizes */}
      {isOpen && (
        <div className="fixed inset-0 z-50 xl:hidden">
          ...
          {/* Slide-in Menu Panel - Responsive width */}
          <div className="absolute top-0 left-0 h-full w-4/5 sm:w-3/5 md:w-2/5 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out translate-x-0">
            {/* Menu Header */}
            ...
            <div className="px-4 sm:px-6 py-6 sm:py-8">
              ...
              <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-neutral-200">
                <h4 className="text-xs sm:text-sm font-semibold text-neutral-900 mb-3 sm:mb-4 uppercase tracking-wide">
                  Get in Touch
                </h4>
                <div className="space-y-1 sm:space-y-2">
                  <p className="text-xs sm:text-sm text-neutral-600">
                    hello@osothestudio.com
                  </p>
                  <p className="text-xs sm:text-sm text-neutral-600">
                    (555) 123-4567
                  </p>
